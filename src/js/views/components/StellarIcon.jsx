...
var StellarIcon = React.createClass({

    render: function() {
        return (
            <svg viewBox="0 0 78.4 21.5" height="33">
                <g>
                    <g>
                        <path fill="#FFFFFF" d="M26.5,9.2c-3.1,0-5,1.6-5.4,3.7c-1,4.4,5,3.2,4.5,5.3c-0.2,0.6-0.7,1-1.3,1c-0.3,0-0.6-0.1-0.7-0.4
