    ...
    render: function() {
        ...
        return (
            <svg viewBox="0 0 73 12" width="73" height="12">
                <defs>
                    <clipPath id="starMask">
                        <path x="0" y="0" fill="#FFFFFF" d="M8.6,3.8L6.5,0L4.4,3.8L0,4.6l3,3.1L2.5,12l4-1.8l4,1.8L10,7.7
			...
			l3-3.1L53.6,3.8z M73,4.6l-4.4-0.8L66.5,0l-2.1,3.8L60,4.6l3,3.1L62.5,12l4-1.8l4,1.8L70,7.7L73,4.6z"/>
                ...
                <g style={{ clipPath: "url(#starMask)" }} width="100%" height="100%">
                    <rect x="0" y="0" width="100%" height="100%" fill={"#"+ConfigStore.getDarkGreen()} />
                    <rect x="0" y="0" width={percent} height="100%" fill={"#"+ConfigStore.getGreen()} />
                </g>
