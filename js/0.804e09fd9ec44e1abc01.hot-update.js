	        ...
	        toggleRunOnLogin: {
	            value: function toggleRunOnLogin() {
	                ...
	                OSXUtil.checkIfRunOnLoginEnabled((function (arg, enabled) {
	                    ...
	                    if (!enabled) OSXUtil.enableRunOnLogin(result.bind(this));else OSXUtil.disableRunOnLogin(result.bind(this));
	                }).bind(this));
...
//# sourceMappingURL=0.804e09fd9ec44e1abc01.hot-update.js.map