	...
	var ReviewList = React.createClass({displayName: "ReviewList",
	    ...
	    render: function () {
	        ...
	        if (reviewItems.length == 0)
	            reviewItems.push(React.createElement("div", {className: "no-item-msg"}, React.createElement("p", null, "Add a starlet with the ", React.createElement(AddButton, null), " button!")))
